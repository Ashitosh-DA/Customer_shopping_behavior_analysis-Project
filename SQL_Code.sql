...
count(customer_id) toatl_customer,
ROUND (avg(purchase_amount),1) As AVG_spent, 
ROUND (Sum(purchase_amount),1) as  Total_Revenu
from customer
group by subscription_status
order by Total_Revenu,AVG_spent desc ;
